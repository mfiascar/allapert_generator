 ...
 *
 * SR, 30-06-2005
 * In 'AssignOneMetre', add a flag to close the sequence for the specific
 * LHC case. Without, I could not use the function to load the SPS
 * aperture (SPSlength = 6911 m)
 *
 *
 * SR, 29-01-2007: Delete the C includes
 *
 */
